...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final date = widget.workout.startTime.toLocal();
    final formattedDate =
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildStatColumn('PACE', widget.workout.formattedPace),
                        _buildStatColumn(
                            'TIME', _formatDuration(widget.workout.duration)),
                        _buildStatColumn(
                            'CALORIES', '${widget.workout.caloriesBurned}'),
                      ],
                    ),
                    const SizedBox(height: 40),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                'GPS Points: ${widget.workout.route.length}',
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                'Started: ${_formatDateTime(widget.workout.startTime)}',
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                                ),
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                'Ended: ${_formatDateTime(widget.workout.endTime)}',
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                                ),
              ...
              children: [
                _buildActionButton(
                  ...
                  () async {
                    ...
                    final saved =
                        await storageService.saveWorkout(widget.workout);
  ...
  Widget _buildRouteMap() {
    ...
    final latLngRoute = widget.workout.toLatLngList();
